package org.lizhao.validator.view.controller;
...
import org.lizhao.validator.model.DeviceSCADAInputInfo;
import org.lizhao.validator.model.ProgressModel;
import org.lizhao.validator.service.AlarmService;
import org.lizhao.validator.utils.SpringUtils;
import org.lizhao.validator.view.async.*;
...
public class MainController {
    ...
    public void download(ActionEvent event) {
        ...
        DownloadService downloadService = ServiceBuilder.builder(DownloadService.class)
                .task(() -> {
                    try (
