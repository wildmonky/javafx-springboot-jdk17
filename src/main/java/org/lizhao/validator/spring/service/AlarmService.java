...
import org.lizhao.validator.spring.enums.DeviceTypeEnum;
import org.lizhao.validator.spring.exception.PatternNotMatchException;
import org.lizhao.validator.spring.mapper.AlarmRegexMapper;
import org.lizhao.validator.spring.mapper.AlarmTypeMapper;
import org.lizhao.validator.spring.mapper.DeviceMapper;
import jakarta.annotation.PostConstruct;
import org.lizhao.validator.spring.entity.AlarmRegex;
import org.lizhao.validator.spring.entity.Device;
import org.lizhao.validator.spring.exception.CustomException;
...
import org.lizhao.validator.spring.event.DeviceFlushEvent;
import org.lizhao.validator.spring.model.*;
    ...
    public void createExcel(String currentUserName, Map<SheetInfo, List<AlarmInfo>> infoMap, OutputStream outputStream) {
        try (XSSFWorkbook xssfWorkbook = new XSSFWorkbook()){
            ...
            for (SheetInfo sheetInfo : sheetInfos) {
                ...
                firstCell.setCellValue("远动信息校核问题清单");
